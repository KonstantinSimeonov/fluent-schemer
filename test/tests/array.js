...
function arrayTests(expect, getFluentSchemer, testTemplates) {
	...
	describe('ArraySchema individual methods', () => {
		...
		it('ArraySchema.withLength(): .withLength() should return errors for arrays with different length', () => {
		...
		it('ArraySchema.withLength(): .withLength() should not return errors for arrays with same length', () => {
			const schema = array().withLength(3),
		...
		it('ArraySchema.distinct(): .distinct() should return error for arrays with duplicate values', () => {
		...
		it('ArraySchema.distinct(): .distinct() should not return error for arrays with distinct values', () => {
			const schema = array().distinct(),
